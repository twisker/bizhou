...
| H-12 | **v1.1.0 发版**：`scripts/bump-minor.sh` 升至 1.1.0 → `git push` → npm publish → Homebrew/Scoop manifest 更新 → GitHub Release（下游 `../bizhouzizhen` 的 Sprint 3 在等这个包）。 | v1.1.0 | P0 | 待执行 |
