...
| 编号 | 事项 | 完成日期 | 备注 |
|------|------|---------|------|
| H-12 | **v1.1.0 发版完成**：GitHub Release（tarball sha256 37c0534d…）+ npm `@bizhou/core@1.1.0`/`@bizhou/cli@1.1.0` + Homebrew tap + Scoop bucket + 文档站已部署 | 2026-07-25 | 发版中发现打包 tarball 不可复现（mtime + gzip 时间戳），已修并**重打 v1.1.0 tag**，使产物可从 tag 复现 |
